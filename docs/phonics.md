...
특히 발음을 만드는 위치(조음 위치)나 방식(조음 방식)은 같은데, 유성음인 소리, 무성음인 소리를 잘 구별해주는 것이 중요해요.<br>
`V`와 `F`를 예로 들 수 있겠네요. 둘다 앞니로 아랫입술을 살짝 깨물듯 소리를 내지만 V는 성대를 울리고 F는 성대를 울리지 않고 바람이 빠져나가는 듯한 소리만 납니다.<br>

## 강세
영어에는 강세가 있는데요. 단어의 특정 음절을 강하게 발음하는 것을 말해요.
